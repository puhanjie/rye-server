...
public interface FileService extends IService<File> {
    ...
    List<FileVO> upload(MultipartFile[] files, HttpServletRequest request) throws HttpException;

    boolean remove(String path, HttpServletRequest request);

    void download(String path, HttpServletRequest request, HttpServletResponse response) throws HttpException;
